...
inline constexpr int kWorldWidth = 1200;
inline constexpr int kWorldHeight = 1200;
inline constexpr int kStarCount = 970;
...
inline constexpr float kGravityConstant = 12.7f;
